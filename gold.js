...
plotChart("https://aravindsp.github.io/cs498datavis/gold/2020.csv","line");
...
if(d3.select("#Checkbox2019").property("checked"))
    {
        plotChartBack("https://aravindsp.github.io/cs498datavis/gold/2019.csv","line2019");
    }
        else {
...
if(d3.select("#Checkbox2018").property("checked"))
    {
        plotChartBack("https://aravindsp.github.io/cs498datavis/gold/2018.csv","line2018");
    }
        else {
...
function update2017(){
        if(d3.select("#Checkbox2017").property("checked"))
            {
                plotChartBack("https://aravindsp.github.io/cs498datavis/gold/2017.csv","line2017");
            }
                else {
